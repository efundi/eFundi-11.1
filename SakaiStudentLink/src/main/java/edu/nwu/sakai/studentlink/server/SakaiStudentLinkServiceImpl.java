...
public class SakaiStudentLinkServiceImpl extends RemoteServiceServlet
    ...
    public List<ModuleDetail> searchModules(Map<SearchCriteria, String> criteria)
        ...
        List<ModuleDetail> modules = null;
        try {
            ...
            List<ModuleDetail> linkedModules = moduleLink.getAllModulesLinkedToLecturer(criteria);
            ...
            for (ModuleDetail module : modules) {
                if (linkedModules.contains(module) && (methodOfDeliveryCode == null ? true : Integer.valueOf(methodOfDeliveryCode).compareTo(module.getMethodOfDeliveryCode()) == 0) 
                		&& (presentationCategoryCode == null ? true : Integer.valueOf(presentationCategoryCode).compareTo(module.getPresentationCategoryCode()) == 0) 
